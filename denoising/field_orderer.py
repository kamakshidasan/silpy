...
class FieldOrderer3D:
    ...
    def compute_minimum_field(field, minimum_points, field_name='order'):
        ...
        return FieldOrderer3D.compute_extremum_order(field, minimum_points, field_name, False)

    @staticmethod
    def compute_maximum_field(field, maximum_points, field_name='order'):
        # all maximum points should be included
        return FieldOrderer3D.compute_extremum_order(field, maximum_points, field_name, True)
